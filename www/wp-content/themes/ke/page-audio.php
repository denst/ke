                                                ...
                                                <div class="wrapper p3">
                                                        <article class="grid_4 alpha">
                                                                <div class="padding-grid-2">
                                                                        <div class="wrapper">
                                                                                <figure class="style-img-2 fleft"><a href="#"><img src="<?php bloginfo('template_directory')?>/images/page2-img1.jpg"  alt=""></a></figure>
                                                                        </div>
                                                                </div>
                                                        </article>
                                                        <article class="grid_8 alpha">
                                                                <div class="padding-grid-2">
                                                                        <h4 class="margin-none indent-top1"><strong>2011.</strong>  Genres Remixes</h4>
                                                                        ...
                                                                        <div class="wrapper">
                                                                                <ul class="list-1 fleft">
                                                                                        <li><a href="#">01. Duis aute irure dolor</a></li>
