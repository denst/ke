                        <div class="slider-wrapper">
                            <div class="slider">
                                <ul class="items">
                                    <li><img src="<?php bloginfo('template_directory')?>/images/slider-img1.jpg" alt="" /></li>
                                    <li>
                                        <img src="<?php bloginfo('template_directory')?>/images/slider-img2.jpg" alt="" />
                                    </li>
                                    <li>
                                        <img src="<?php bloginfo('template_directory')?>/images/slider-img3.jpg" alt="" />
                                    </li>
                                </ul> 
                            </div>
                        </div>    
                                        ...
                                        <div class="wrapper">
                                                ...
                                                <article class="grid_4 alpha">
                                                        <div class="padding-grid-2">
                                                                ...
                                                                <div class="wrapper">
                                                                        <figure class="style-img fleft"><a href="#"><img src="<?php bloginfo('template_directory')?>/images/page2-img1.jpg"  alt=""></a></figure>
                                                                </div>
                                                        </div>
                                                </article>
                                        </div>
                                ...
                                <div class="wrapper">
                                        ...
                                        <article class="grid_4 alpha">
                                                <div class="padding-grid-2">
                                                        ...
                                                        <div class="wrapper">
                                                                <figure class="style-img-2 fleft"><a class="lightbox-image" href="<?php bloginfo('template_directory')?>/video/video_AS3.swf?width=495&amp;height=275&amp;fileVideo=intro06.flv" data-gal="prettyVideo[prettyVideo]"><img src="<?php bloginfo('template_directory')?>/images/page1-img2.jpg"  alt=""></a></figure>
                                                        </div>
                                                </div>
                                        </article>
                                        <article class="grid_4 alpha">
